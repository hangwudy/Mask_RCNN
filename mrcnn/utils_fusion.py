...
class Dataset(object):
    ...
    def load_pose(self, image_id):
        ...
        Returns:
            latitude: An array of shape [latitude_id, instance count]
            longitude: An array of shape [latitude_id, instance count]
        """
        # Override this function to load a mask from your dataset.
        # Otherwise, it returns an empty array.
        latitude_ids = np.empty([0], np.int32)
        longitude_ids = np.empty([0], np.int32)
