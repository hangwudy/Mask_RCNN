...
def fpn_classifier_graph(rois, feature_maps, image_meta,
                         pool_size, num_classes, num_classes_latitude, 
                         num_classes_longitude, train_bn=True,
                         fc_layers_size=1024):
    ...
    # Pose Net head
    mrcnn_pose_latitude = KL.TimeDistributed(KL.Dense(num_classes_latitude),
                                    name='mrcnn_pose_latitude')(shared)
